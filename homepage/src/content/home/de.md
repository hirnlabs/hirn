...
description: "hirn ist ein modulares, privates und verteiltes lokales System für Agenten, das du selbst besitzt und kontrollierst."
hero:
  eyebrow: "Der Assistent, der wirklich dir gehört."
  title: "Modular. Privat. Open."
  lead: "Ein modulares Agentensystem, das du selber kontrollierst. Spreche oder tippe, um deine täglichen Workflows zu automatisieren. Standardmäßig läuft jede App, jedes Modell und jedes Training zu 100% lokal."
...
why:
  ...
  description: "Die meisten Agentensysteme setzen auf Cloud-Dienste, verstreute Tools und geschlossene Plattformen. hirn wurde von Grund auf entwickelt, um dir volle Datensouveränität zu geben."
  reasons:
    - eyebrow: "Local-First"
    ...
    - eyebrow: "Geräteübergreifend"
      ...
      description: "Nahtlose, Ende-zu-Ende verschlüsselte P2P-Synchronisation zwischen all deinen Geräten unter Linux, Windows und Android ohne zentrale Server."
    - eyebrow: "Erweiterbar"
    ...
    - eyebrow: "Modell-Ebene"
      ...
      description: "Verteiltes lokales Modell-Serving für effiziente Inferenz und ein intelligenter Intent-Router, der für jede Anfrage das optimale Modell wählt."
...
how:
  ...
  title: "Lokaler Markdown-Graph Index & Agenten-Gedächtnis"
  description: "hirn verwandelt einfache lokale Markdown-Notizen in einen verknüpften Wissens-Graphen – für tiefes Agenten-Gedächtnis und einfache Zeug-Entwicklung."
  features:
    - icon: "markdown"
      eyebrow: "Plain Text First"
      title: "Lokale Markdown-Notizen"
      description: "Keine proprietären Datenbanken oder Cloud-Lock-in. Alles wird in lokalen, menschenlesbaren Markdown-Dateien gespeichert."
    - icon: "graph"
      eyebrow: "Haupt-Feature"
      title: "Graph-Index & Gedächtnis"
      description: "Erstellt einen bidirektionalen Graph-Index über deine Markdown-Notizen – ähnlich wie Obsidian oder Anytype – für sofortigen Agenten-Kontext."
    - icon: "sdk"
      eyebrow: "Entwickler-SDK"
      title: "Zeug auf dem Graphen bauen"
      description: "Nutze das hirn SDK, um kleine Web-Apps (Zeug) direkt auf deiner lokalen Graph-Struktur mit eigenen Oberflächen zu bauen."
pillars:
...
developer:
  ...
  description: "Entwickle ein Zeug, binde es in das hirn-Ökosystem ein und vergiss den Rest. Keine Server, keine Deployment-Pipelines, keine Cloud-Rechnungen."
  features:
    ...
    - eyebrow: "Eigene Oberfläche"
      ...
      description: "Liefere eine vollständige HTML- und JS-Oberfläche aus, die in hirn mit einem bidirektionalen, echtzeitfähigen und komplett offline-fähigen SDK öffnet."
    - eyebrow: "Ökosystem"
...
waitlist:
  eyebrow: "Werde Teil der Reise"
  title: "Gehöre zu den Ersten, die hirn nutzen."
