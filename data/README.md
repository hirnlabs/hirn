...
- **Derivability**: The query index (Tier 3) and collaborative state (Tier 2) are fully derivable from the canonical files (Tier 1). If the index corrupts, it can be regenerated by scanning the file system.
